...
public class HealthFragment extends Fragment implements android.support.v4.app.LoaderManager.LoaderCallbacks<Cursor>,
    ...
    public android.support.v4.content.Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return FragmentUtils.fragmentLoader(getActivity(), QueryUtils.CATEGORY_HEALTH);
    }
